...
@section('content')
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form class="form-horizontal" role="form" id="editArticleForm" method="POST"
                  action="{{ route('article_update',$article->id) }}">
                {{ csrf_field() }}
                        ...
                        @foreach( $tag as $tag_v)
                            <label class="checkbox-inline i-checks">
                                <input type="checkbox" value="{{$tag_v->id}}" name="tag_ids[]"
                                       @if(in_array($tag_v->id, $article->tag_ids)) checked="checked" @endif>
                                &nbsp;{{$tag_v->name}}
                            </label>
                        @endforeach
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <label class="radio-inline i-checks">
                            <input type="radio" value="0" name="status" value="1"
