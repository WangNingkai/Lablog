                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('site_status'))
                                        <span class="help-block"><strong>{{ $errors->first('site_status') }}</strong></span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('site_close_word'))
                                        <span class="help-block"><strong>{{ $errors->first('site_close_word') }}</strong></span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('site_info'))
                                        <span class="help-block"><strong>{{ $errors->first('site_info') }}</strong></span>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="site_keywords" id="site_keywords" value="{{ $config['site_keywords'] }}">
                                        ...
                                        <span class="help-block"><strong>{{ $errors->first('site_keywords') }}</strong></span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="site_description" id="site_description" value="{{ $config['site_description'] }}">
                                        ...
                                        <span class="help-block"><strong>{{ $errors->first('site_description') }}</strong></span>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_admin') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_admin_avatar') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_admin_info') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_mailto_admin') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_admin_mail') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_admin_weibo') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('site_admin_github') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="site_icp_num" id="site_icp_num" value="{{ $config['site_icp_num'] }}">
                                        ...
                                        <span class="help-block"><strong>{{ $errors->first('site_icp_num') }}</strong></span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="site_110beian_num" id="site_110beian_num" value="{{ $config['site_110beian_num'] }}">
                                        ...
                                        <span class="help-block"><strong>{{ $errors->first('site_110beian_num') }}</strong></span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="site_110beian_link" id="site_110beian_link" value="{{ $config['site_110beian_link'] }}">
                                        ...
                                        <span class="help-block"><strong>{{ $errors->first('site_110beian_link') }}</strong></span>
                                    @endif
                                </div>
                            </div>
                        </div>
