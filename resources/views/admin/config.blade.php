                                ...
                                <div class="tab-pane" id="tab_3">
                                    <div class="form-group {{$errors->has('site_allow_comment')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_allow_comment'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_allow_comment') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_allow_message')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_allow_message'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_allow_message') }}</strong></span>
                                        @endif
                                    </div>
                                        ...
                                        <div class="radio">
                                            <label class="i-checks">
                                                <input type="radio" name="site_allow_subscribe" value="1"
                                                       @if($config[ 'site_allow_subscribe']==1) checked @endif> &nbsp;
                                                开启
                                            </label>
                                            <label class="i-checks">
                                                <input type="radio" name="site_allow_subscribe" value="0"
                                                       @if($config[ 'site_allow_subscribe']==0) checked @endif> &nbsp;
                                                关闭
                                            </label>
                                        </div>
                                        @if ($errors->has('site_allow_subscribe'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_allow_subscribe') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('allow_reward')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('allow_reward'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('allow_reward') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('alipay')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('alipay'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('alipay') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('wepay')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('wepay'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('wepay') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="water-mark">
                                            <a data-toggle="modal" href='#water-mark-modal'>
                                                <img class="img-responsive" src="{{ asset('img/water_mark.png') }}"
