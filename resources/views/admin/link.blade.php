        ...
        <section class="content container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <div class="box-body ">
                            <table class="table table-hover">
                                ...
                                @if(!blank($links))
                                    @foreach ($links as $link)
                                        <tr>
                                            <td><input type="checkbox" value="{{$link->id}}" name="lid"
                                                       class="i-checks"></td>
                                            <td>{{$link->name}}</td>
                                            <td>
                                                {{$link->url}}
                            ...
                            <form id="deleteForm" style="display: none;" action="{{route('link_destroy')}}"
                                  method="post">
                                @csrf
                        ...
                        <div class="box-footer clearfix">
                            <div class="pull-left">
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat"
                                   onclick="selectAll('lid')">全选</a>
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat"
                                   onclick="selectEmpty('lid')">全不选</a>
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat"
                                   onclick="selectReverse('lid')">反选</a>
                                <a href="javascript:void(0)" class="btn btn-danger btn-flat"
                                   id="delSelectedLink">删除选定</a>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <form role="form" method="POST" action="{{route('link_update')}}" id="editLinkForm"
                          style="display:none;">
                        @csrf
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group {{$errors->has('edit_name')?'has-error':''}}">
                                    ...
                                    <input type="text" class="form-control" name="edit_name" id="editName"
                                           placeholder="请输入友链名" value="{{ old('edit_name')?old('edit_name'):'' }}">
                                ...
                                <div class="form-group {{$errors->has('edit_url')?'has-error':''}}">
                                    ...
                                    <input type="text" class="form-control" name="edit_url" id="editUrl"
                                           placeholder="请输入友链链接" value="{{ old('edit_url')?old('edit_url'):'' }}">
                                    <span class="help-block text-red">链接前请加上协议(如:https://xxx.com)</span>
                                    @if ($errors->has('edit_url'))
                                        <span class="help-block "><strong><i
                                                    class="fa fa-times-circle-o"></i>{{ $errors->first('edit_url') }}</strong></span>
                                    @endif
                                </div>
                                <div class="form-group {{$errors->has('edit_sort')?'has-error':''}}">
                                    <label for="editSort">排序：</label>
                                    <input type="text" class="form-control" name="edit_sort" id="editSort"
                                           placeholder="请输入友链排序" value="{{ old('edit_sort')?old('edit_sort'):'' }}">
                                    @if ($errors->has('edit_sort'))
                                        <span class="help-block "><strong><i
                                                    class="fa fa-times-circle-o"></i>{{ $errors->first('edit_sort') }}</strong></span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                <div class="form-group {{$errors->has('name')?'has-error':''}}">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="请输入友链名"
                                           value="{{old('name')}}">
                                    @if ($errors->has('name'))
                                        <span class="help-block "><strong><i
                                ...
                                <div class="form-group {{$errors->has('url')?'has-error':''}}">
                                    <label for="url">链接：</label>
                                    <input type="text" class="form-control" name="url" id="url" placeholder="请输入友链链接"
                                           value="{{old('url')}}">
                                    <span class="help-block text-red">链接前请加上协议(如:https://xxx.com)</span>
                                    @if ($errors->has('url'))
                                        <span class="help-block "><strong><i
                                ...
                                <div class="form-group {{$errors->has('sort')?'has-error':''}}">
                                    ...
                                    <input type="text" class="form-control" name="sort" id="sort" placeholder="请输入友链排序"
                                           value="{{old('sort')}}">
                                    @if ($errors->has('sort'))
                                        <span class="help-block "><strong><i
