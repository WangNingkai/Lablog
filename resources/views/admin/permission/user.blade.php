            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-solid">
                        <div class="box-body">
                            <a href="{{ route('user_create') }}" class="btn btn-success btn-flat"><i
                                    class="fa fa-user-plus"></i>&nbsp;添加用户</a>&nbsp;&nbsp;
                            <a href="{{ route('user_trash') }}" class="btn btn-danger btn-flat"><i
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <form action="{{ route('user_search') }}" method="get" style="display: inline-flex"
                                  class="pull-right">
                                <div class="box-tools">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                @if(!blank($users))
                                    @foreach($users as $user)
                                        <tr>
                                            <td><input type="checkbox" value="{{$user->id}}" name="uid"
                                                       class="i-checks"></td>
                                            <td>{{ $user->id }}</td>
                                            <td>{{ $user->name }}</td>
                            ...
                            <form id="deleteForm" style="display: none;" action="{{ route('user_delete') }}"
                                  method="post">
                                @csrf
                        ...
                        <div class="box-footer clearfix">
                            <div class="pull-left">
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat"
                                   onclick="selectAll('uid')">全选</a>
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat"
                                   onclick="selectEmpty('uid')">全不选</a>
                                <a href="javascript:void(0)" class="btn btn-primary btn-flat"
                                   onclick="selectReverse('uid')">反选</a>
                                <a href="javascript:void(0)" class="btn btn-danger btn-flat"
                                   id="delSelectedUser">删除选定</a>
                            </div>
