                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">{{ $name }}
                                        ，您好！</h1>
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">
                                        此邮件用为系统自动发送，请勿直接回复<br>如需帮助请前往
                                        <a href="{{ config('app.url') }}"
                                           style="text-decoration: underline; color: #999999; font-size: 12px; text-align: center;">{{ config('app.name') }}</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">
                                        Copyright &copy; {{date('Y')}} {{ config('app.name') }}. All rights
                                        reserved.</p>
                                </td>
                            </tr>
                        </table>
