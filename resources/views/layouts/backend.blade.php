        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview {{ \App\Helpers\Extensions\Tool::setActive(['admin/tag','admin/category','admin/article','admin/page']) }} ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/tag') }}"><a
                                href="{{ route('tag_manage') }}"><i class="fa fa-tags"></i> 标签管理</a></li>
                ...
                <li class="treeview {{ \App\Helpers\Extensions\Tool::setActive(['admin/link','admin/message','admin/comment','admin/subscribe']) }} ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/link/manage') }}"><a
                                href="{{ route('link_manage') }}"><i class="fa fa-link"></i> 我的友链</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/comment/manage') }}"><a
                                href="{{ route('comment_manage') }}"><i class="fa fa-comment"></i> 我的评论</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/message/manage') }}"><a
                                href="{{ route('message_manage') }}"><i class="fa fa-comments"></i> 我的留言</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/subscribe/manage') }}"><a
                                href="{{ route('subscribe_manage') }}"><i class="fa fa-first-order"></i> 我的订阅</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview {{ \App\Helpers\Extensions\Tool::setActive(['admin/permission','admin/user','admin/role']) }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/user') }}"><a
                                href="{{ route('user_manage') }}"><i class="fa fa-user"></i> 用户管理</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/role') }}"><a
                                href="{{ route('role_manage') }}"><i class="fa fa-users"></i> 角色管理</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/permission') }}"><a
                                href="{{ route('permission_manage') }}"><i class="fa fa-lock"></i> 权限管理</a></li>
                    </ul>
                </li>
                ...
                <li class=""><a href="{{ url('admin/debug-log') }}"><i class="fa fa-bug"></i> <span> 调试日志</span></a>
                </li>
                @endrole
                <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/image/list') }}"><a
                        href="{{ route('image_list') }}"><i class="fa fa-image"></i> <span>图床</span></a></li>
            </ul>
        </section>
    </aside>
